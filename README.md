...
2. Include this ip on your hosts-file
    ...
    ```
    echo 127.0.0.1 blog.acme.com.test >> c:\windows\System32\drivers\etc\hosts
    ```
...
4. Generate ssl certs for local development
    ```
    mkcert --cert-file docker/files/certs/cert.pem --key-file docker/files/certs/cert-key.pem blog.acme.com.test
    ```
...
7. Install and start frontend
    ...
    npm run dev
    ```
8. Visit your site on: [https://blog.acme.com.test:8082](https://blog.acme.com.test:8082)
    - ...or login to [https://blog.acme.com.test:8082/wt/cms](https://blog.acme.com.test:8082/wt/cms) (Username: `admin` and password: `admin`)
...
Acme-Blog is proprietary software. All rights reserved.
